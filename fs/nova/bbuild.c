	...
	struct nova_inode_info_header *sih, u16 i_mode)
{
	...
	sih->time_lock.val.counter=__ARCH_SPIN_LOCK_UNLOCKED;
	sih->tail_lock.val.counter=__ARCH_SPIN_LOCK_UNLOCKED;
	sih->size_lock.val.counter=__ARCH_SPIN_LOCK_UNLOCKED;
	sih->log_lock.val.counter=__ARCH_SPIN_LOCK_UNLOCKED;
	sih->block_lock.val.counter=__ARCH_SPIN_LOCK_UNLOCKED;
	sih->tree_lock.val.counter=__ARCH_SPIN_LOCK_UNLOCKED;
}
